...
const int redLEDPin = 11;           // set redLEDPin as 11 alias
const int blueLEDPin = 10;          // set blueLEDPin as 10 alias
const int greenLEDPin = 9;          // set greenLEDPin as 9 alias

const int redSensorPin = A0;        // set redSensorPin as A0 alias
const int greenSensorPin = A1;      // set greenSensorPin as A1 alias
const int blueSensorPin = A2;       // set blueSensorPin as A2 alias

int redLEDValue = 0;                // init redLEDValue = 0
int blueLEDValue = 0;               // init blueLEDValue = 0
int greenLEDValue = 0;              // init greenLEDValue = 0

int redSensorValue = 0;             // init redSensorValue = 0
int blueSensorValue = 0;            // init blueSensorValue = 0
int greenSensorValue = 0;           // init greenSensorValue = 0
