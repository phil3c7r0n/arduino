...
const byte led1_pin   = 2; // connect led1 to 2
const byte led2_pin   = 3; // connect led2 to ~3
const byte led3_pin   = 4; // connect led3 to 4
const byte led4_pin   = 5; // connect led4 to ~5
const byte led5_pin   = 6; // connect led5 to ~6
const byte led6_pin   = 7; // connect led6 to 7
...
byte current_led        = led1_pin;
unsigned long interval  = 2000; // time delay between each event

void setup() {
    for (byte led = led1_pin; led <= led6_pin; led++) {
        pinMode(led, OUTPUT);
    }
