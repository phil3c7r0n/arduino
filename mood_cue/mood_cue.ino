...
const int potPin = A0;  // set potPin as A0 alias
const int servoPin = 3; // set servoPin as 3 alias
int potVal;             // declare potVal as the value of potentiometer
int angle;              // declare angle as the angle of the servo motor
